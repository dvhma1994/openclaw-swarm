    ...
    def _load(self):
        if self.store_path.exists():
            try:
                ...
                logging.warning("Failed to load automatic memory", exc_info=True)
    ...
    def _load(self):
        if self.store_path.exists():
            try:
                ...
                logging.warning("Failed to load conscious memory", exc_info=True)
    ...
    def _load(self):
        if self.store_path.exists():
            try:
                ...
                logging.warning("Failed to load knowledge graph", exc_info=True)
