...
def main():
    ...
    print(f"Context (max 100 tokens):")
    print(context[:200] + "...")
    ...
    print(f"Query: python (min_score: 0.5)")
    print(f"Results: {len(results)}")
    ...
    long_text = "This is a long piece of text that will be chunked into smaller pieces. " * 5
