...
def main():
    ...
    # Register hooks
    manager.register("agent_start_logger", HookType.AGENT_START, on_agent_start, priority=10)
    manager.register("agent_end_logger", HookType.AGENT_END, on_agent_end, priority=10)
    manager.register("agent_error_handler", HookType.AGENT_ERROR, on_agent_error, priority=5)
    ...
    manager.register("memory_retrieve_logger", HookType.MEMORY_RETRIEVE, on_memory_retrieve)
    ...
    manager.register("swarm_start_logger", HookType.SWARM_START, on_swarm_start, priority=20)
