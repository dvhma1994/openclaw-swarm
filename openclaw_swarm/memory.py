...
class Memory:
    ...
    def find_similar(
        ...
        for entry in self.memories.values():
            if query_lower in entry.input_data.lower() or \
               query_lower in entry.output_data.lower() or \
               query_lower in entry.task.lower():
    ...
    def export(self, filepath: str) -> None:
        ...
        console.print(f"[green]Exported {len(self.memories)} memories to {filepath}[/green]")
